...
FailedDeliveryLogPath = "C:\MGLog\failed_Delivery.txt"
...
if lcase(oMessage.From) = "hmailserver" THEN Exit Sub 'Do not run for messages from hMailServer that are sent from CreateFailedDeliveryLogMessage
